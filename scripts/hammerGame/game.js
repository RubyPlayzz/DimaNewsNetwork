...
const LOSE_ENEMY_COUNT = 200; // How many enemies can spawn until the player loses
...
const START_ENEMY_SPAWN_DELAY = 170; // How many miliseconds it takes before enemies will spawn. This is subtracted by ENEMY_SPAWN_DELAY_DECREASE every few kills
